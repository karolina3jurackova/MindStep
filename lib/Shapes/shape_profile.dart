...
class ShapeFocus extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const Color topWaveColor =
        Color.fromARGB(255, 232, 182, 125); // vrchná tmavšia vlna
    const Color cardColor = Color.fromARGB(255, 255, 246, 235); // karta

    // ===== 1. Pozadie =====
    canvas.drawRect(
      Rect.fromLTWH(0, 0, w, h),
      Paint()..color = const Color.fromARGB(255, 255, 224, 189),
    );
    ...
    final double cardHeight = h - cardTop + 60;

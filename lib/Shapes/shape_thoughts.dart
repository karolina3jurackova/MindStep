...
class ShapeRunningFocus extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      ...
      Paint()..color = const Color(0xFFF8DDB7),
    );
  ...
  void _drawCornerMotif(
    ...
    final Paint lightPaint = Paint()
      ..color = const Color.fromARGB(255, 230, 178, 126).withValues(alpha: 0.45)
      ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 5)
      ..isAntiAlias = true;

    final double offsetY = -h * 0.10;
    ...
    final Paint darkPaint = Paint()
      ..color = const Color.fromARGB(255, 224, 176, 124)

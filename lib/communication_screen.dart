          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.self_improvement, size: 15, color: Color(0xFF6E3E09)),
                    ...
                    if (hasStarted && !fullyDone) ...[
                      ...
                      const SizedBox(width: 4),
                      Text('Den $displayDay z ${task.totalDays}',
                          style: GoogleFonts.josefinSans(
            ...
            child: SafeArea(
              ...
              child: Column(
                children: [
                  ...
                  Text('Vyber jednu malou komunikační dovednost',
                      style: GoogleFonts.judson(
                          color: const Color(0xFF6E3E09), fontSize: 21, fontWeight: FontWeight.w500)),
                  const SizedBox(height: 20),
                  Expanded(
                    child: ListView.builder(
                      padding: const EdgeInsets.fromLTRB(16, 0, 16, 110),
                      itemCount: communicationTasks.length,
                      itemBuilder: (context, index) {
                        return _taskCard(context, communicationTasks[index]);
                      },
                    ),
                  ),
                ],
